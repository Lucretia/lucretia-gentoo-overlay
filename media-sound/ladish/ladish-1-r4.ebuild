...
if [[ ${PV} == *9999 ]]; then
	inherit git-r3
	EGIT_REPO_URI="http://git.nedk.org/lad/ladish.git"
	KEYWORDS=""
	EGIT_SUBMODULES=()
else
	inherit vcs-snapshot
	SRC_URI="http://github.com/LADI/ladish/archive/${P}.tar.gz
		http://git.nedk.org/lad/ladish.git/plain/waf?id=f15b80e6394ba0cbb4b76aa1b32071bfb971a8fa -> ${P}-waf-2.0.22"
	KEYWORDS="~amd64"
fi
LICENSE="GPL-2"
SLOT="0"
